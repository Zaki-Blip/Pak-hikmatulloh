...
<div class="space-y-6">
    ...
    <div class="bg-gradient-to-r from-primary-600 to-primary-700 rounded-2xl p-6 text-white shadow-lg">
        ...
        <p class="text-primary-100 mt-1">Panel Sekolah untuk {{ auth()->user()->role === 'admin' ? 'Administrator' : 'Pengguna' }}</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div class="bg-white rounded-xl p-6 shadow-sm border border-slate-200 hover:shadow-md transition">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-slate-500 text-sm">Tingkat Kelulusan</p>
                    <p class="text-3xl font-bold text-accent-600 mt-1">{{ $graduationRate }}%</p>
                </div>
            ...
            <p class="mt-4 text-slate-400 text-sm">Perbandingan lulusan</p>
        </div>
    </div>
