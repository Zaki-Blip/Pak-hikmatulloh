...
<div class="w-full max-w-md">
    ...
    <div class="text-center mb-8">
        ...
        <h1 class="text-2xl font-bold text-slate-800">SMKN 64 JAKARTA</h1>
        <p class="text-slate-500 mt-1">Sekolah Ramah Anak</p>
    </div>
    ...
    <p class="text-center text-slate-500 text-sm mt-6">
        &copy; {{ date('Y') }} SMKN 64 Jakarta. All rights reserved.
    </p>
</div>
