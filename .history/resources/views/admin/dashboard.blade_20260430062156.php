...
<div class="space-y-6">
        ...
        <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-200">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-xl font-bold text-accent-600 mt-1">Aktif</p>
                </div>
    ...
    <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-200">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
            ...
            <a href="{{ route('admin.secret') }}" class="flex flex-col items-center gap-2 p-4 rounded-xl bg-amber-50 hover:bg-amber-100 transition text-center">
                <svg class="w-8 h-8 text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path>
                </svg>
                <span class="text-sm font-medium text-slate-700">Admin Area</span>
            </a>
